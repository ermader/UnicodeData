...
class HeaderFile(object):
    def __init__(self, icuDirectory, cSourcePath, outDirectory):
        ...
        self.headerName = fromName.replace(".", "_")  + ".py" # maybe add .lower()?
        self.headerPath = os.path.join(outDirectory, self.headerName)

        self.outputLines.append(f"{self.headerName}, based on {fromName} from ICU\n")
